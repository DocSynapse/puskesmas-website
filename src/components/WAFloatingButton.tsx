...
const WAFloatingButton = () => {
  ...
  return (
    <a
      ...
      className={`fixed z-40 flex items-center bg-[#25D366] text-white
        bottom-6 right-4 h-14 w-14 justify-center rounded-full shadow-lg shadow-[#25D366]/30
        sm:bottom-6 sm:right-5 sm:h-auto sm:w-auto sm:justify-start sm:gap-2.5 sm:px-4 sm:py-3
    ...
    >
      ...
      <span className="hidden whitespace-nowrap text-sm font-semibold sm:inline">Chat WA</span>
    </a>
  );
};
